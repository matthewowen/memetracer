function memechart(initial) {
    ...
    var mc = {
        chartURL: function (url) {
            $.getJSON("/json?url=" + url,
                function (data) {
                    ...
                    var i, l, k, processed, results = [], largest = 0,
                        unprocessed = [
                            {
                                name: 'reddit',
                    ...
                    for (i = 0; i < unprocessed.length; i++) {
                        ...
                        for (k = 0; k < l.data.length; k++) {
                            ...
                            processed = mc.processItem(l.data[k], l.name);
        ...
        plotOverTime: function (values, largest) {
            ...
            var x, axis, svg, circle;
            x = d3.time.scale.utc().range([100, 800])
